// Get the average number of ordered units per hour in each day during the given time range for the seller
class DashboardApp15(paramMap: Map[String, Any]) extends Serializable {
  import QaaD._
